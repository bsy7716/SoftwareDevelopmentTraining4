 ...
 <div class = "container">
	<div class="wrapper">
		<div class="form-signin" style="text-align:center">       
		    <h3 class="form-signin-heading">예매가 정상적으로 완료 되었습니다.</h3>
		    <h5 style="color:red">예매 번호 : <%=session.getAttribute("ticketNumber") %></h5>
			  <br>
			  <table class="table table-bordered">
                <tbody>
                    ...
                    <tr>
                    <th class="table-primary" style="width:30%; height:10%;">상영관</th>
                    <td style="width:70%; height:10%;"><%=session.getAttribute("movieShowRoom") %></td>
                    </tr>
                    <tr>
                    <th class="table-primary" style="width:30%; height:10%;">좌석</th>
                    <td style="width:70%; height:10%;"><%=session.getAttribute("selectSeat") %></td>
                    </tr>
                    <tr>
                    <th class="table-primary" style="width:30%; height:10%;">결재 금액</th>
                    <td style="width:70%; height:10%;"><%=session.getAttribute("price") %>원</td>
                    </tr>
                </tbody>           
</table>
<div style="text-align:center">
<br>
<button type="button" class="btn btn-primary" style="width:30%" onclick="location.href='Home'">홈으로</button>
<button type="button" class="btn btn-secondary" style="width:30%; margin-left:10%" onclick="location.href='ReservationView'">예매 확인</button>
</div>
	</div>
	</div>
</div>
