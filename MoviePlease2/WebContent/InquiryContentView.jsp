	 ...
	 <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav mr-auto" style="margin-left:200px;">
            ...
            <li class="nav-item" style="margin-left:50px;">
              <a class="nav-link" href="MovieTime">
              <%Member member = (Member)session.getAttribute("members"); %>
     		  <%if(member != null){%>로그인 성공!<%}%><%else{%><%}%>
              </a>
            </li>
          </ul>
          <%if(member != null){%>
...
<!-- Page Content -->
    ...
    <div class="col-md-7">
		<form action="contentview">
			<h3 style="margin-bottom: 25px; text-align: center;">문의 내용</h3>
			제목<input type="text" class="form-control" id="InquiryTitle" name="InquiryTitle" value='${inquiry.inquiryTitle}' readonly><br>
			작성일<input type="text" class="form-control" id="UserDate" name="UserDate" value='${inquiry.inquiryDate}' readonly><br>
			문의내용 <textarea class="form-control" name="InquiryContent" id="InquiryContent" rows="15" cols="60" readonly>${inquiry.inquiryContent}</textarea><br>
			<a href="update?InquiryNo=${inquiry.inquiryNo}" class="btn btn-success">수정</a>
			<a href="inquiry" class="btn btn-primary">확인</a>
		</form>
