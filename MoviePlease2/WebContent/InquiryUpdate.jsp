...
<!-- Page Content -->
    ...
    <div class="col-md-6">
		<form action="update" method="post">
			<h3 style="margin-bottom: 25px; text-align: center;">문의 수정</h3>
			번호<input type="text" class="form-control" id="InquiryNo" name="InquiryNo" value='${inquiry.inquiryNo}' readonly><br>
			제목<input type="text" class="form-control" id="InquiryTitle" name="InquiryTitle" value='${inquiry.inquiryTitle}'><br>
			작성자<input type="text" class="form-control" id="UserName" name="UserName" value='${inquiry.userName}'><br>
			이메일<input type="text" class="form-control" id="UserEmail" name="UserEmail" value='${inquiry.userEmail}'><br>
			작성일<input type="text" class="form-control" id="UserDate" name="UserDate" value='${inquiry.inquiryDate}' readonly><br>
			문의내용 <textarea class="form-control" name="InquiryContent" id="InquiryContent" rows="15" cols="60">${inquiry.inquiryContent}</textarea><br>
			<input  class="btn btn-info pull-right" type="submit" value="수정">
			<input class="btn btn-danger pull-right" type="button" value="삭제" onclick="location.href='delete?InquiryNo=${inquiry.inquiryNo}';">
			<input class="btn btn-default pull-right" type="button" value="취소" onclick="location.href='inquiry'">
		</form>
