...
<!-- 점포트론 시작 -->
    ...
    <div class="jumbotron" style="text-align:center; background-image:url('mainBackground.jpg'); background-size:cover; color:white">
      <h1 class="display-4">영화를 부탁해</h1>
      <p class="lead">이 웹페이지는 소프트웨어 개발실습4의 프로젝트의 일환으로 만들어졌습니다.</p>
      <hr class="my-4">
      <p>영화 예매 사이트 제작실습을 목적으로 한 간단한 웹 페이지 입니다.</p>
    </div>
...
<%for(int i = 0; i<5;i++){ %>
<div class="card border-secondary mb-3" style="max-width: 18rem; margin-left:55px;">
