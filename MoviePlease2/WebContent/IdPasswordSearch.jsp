...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="container">
     ...
     <!-- Page Heading -->
      <h1 class="my-4">아이디 / 비밀번호 찾기
        <small>Search</small>
      </h1>
    <div class="row">  
	<div class="col-md-5">
    <div class="form-area">  
        <form role="form" action='IdPasswordSearchServlet' method='post'>
        <br style="clear:both">
                    <h3 style="margin-bottom: 25px; text-align: center;">아이디 찾기</h3>
        ...
        <input type="submit" id="idSearch" name="submit" class="btn btn-primary pull-right" value="아이디 찾기">
        </form>
    </div>
	</div>
	...
	<div class="col-md-5">
    <div class="form-area">  
        <form role="form"role="form" action='IdPasswordSearchServlet' method='post'>
        <br style="clear:both">
                    <h3 style="margin-bottom: 25px; text-align: center;">비밀번호 찾기</h3>
                    <div class="form-group">
        ...
        <input type="submit" id="passwordSearch" name="submit" class="btn btn-primary pull-right" value="비밀번호 찾기">
        </form>
    </div>
	</div>
	</div>
