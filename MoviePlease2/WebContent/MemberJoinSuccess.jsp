...
<div class = "container">
	<div class="wrapper">
		<div class="form-signin">       
		    <h3 class="form-signin-heading">회원 가입 성공</h3>
			  <hr class="colorgraph">
			  <h6 style="text-align:center">회원가입이 정상적으로 완료되었습니다.</h6>
			  <br>
			  <button class="btn btn-lg btn-primary btn-block" onclick="location.href='Home'">홈으로</button>
		</div>			
	</div>
</div>
